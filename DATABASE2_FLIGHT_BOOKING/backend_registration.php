<?php
    ...
    $createCustomerData = "INSERT INTO customer VALUES ('','{$CUS_LNAME}', '{$CUS_FNAME}','{$CUS_INITIAL}','{$CUS_AREACODE}','{$CUS_PHONE}','{$PRICE}')";
    ...
    $createCharterData = "INSERT INTO charter VALUES ('','{$DATE}','$AC_NUMBER','{$DESTINATION}','','','','','','$lastInsertedCusCode')";
